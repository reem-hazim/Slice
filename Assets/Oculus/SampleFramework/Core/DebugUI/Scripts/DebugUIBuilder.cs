...
public class DebugUIBuilder : MonoBehaviour
{
  ...
  public RectTransform AddButton(string label, OnClick handler, int targetCanvas = 0)
  {
    ...
    ((UnityEngine.UI.Text)(buttonRT.GetComponentsInChildren(typeof(UnityEngine.UI.Text), true)[0])).text = label;
  ...
  public RectTransform AddLabel(string label, int targetCanvas = 0)
  {
    ...
    rt.GetComponent<UnityEngine.UI.Text>().text = label;
  ...
  public RectTransform AddToggle(string label, OnToggleValueChange onValueChanged, int targetCanvas = 0)
  {
    ...
    AddRect(rt, targetCanvas);
    UnityEngine.UI.Text buttonText = rt.GetComponentInChildren<UnityEngine.UI.Text>();
